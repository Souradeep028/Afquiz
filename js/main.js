...
$("#cityrow").html(
  d.cities.citylist.reduce(function (acc, c) {
    return (
      acc +
...
$("#q1row").html(
  d.q1.answerlist.reduce(function (acc, c) {
    return (
      acc +
      `<div class="col-sm" align="center">
...
$("#q2row").html(
  d.q2.answerlist.reduce(function (acc, c) {
    return (
      acc +
      `<div class="col-sm" align="center">
...
$("#q3row").html(
  d.q3.answerlist.reduce(function (acc, c) {
    return (
      acc +
      `<div class="col-sm" align="center">
...
$("#q4row").html(
  d.q4.answerlist.reduce(function (acc, c) {
    return (
      acc +
      `<div class="col-sm" align="center">
...
$("#q5row").html(
  d.q5.answerlist.reduce(function (acc, c) {
    return (
      acc +
      `<div class="col-sm" align="center">
...
$("#q6row").html(
  d.q6.answerlist.reduce(function (acc, c) {
    return (
      acc +
      `<div class="col-sm" align="center">
...
$("#q7row").html(
  d.q7.answerlist.reduce(function (acc, c) {
    return (
      acc +
      `<div class="col-sm" align="center">
